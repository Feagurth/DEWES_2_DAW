    ...
    <body>
        ...
        if (!isset($mensajeError)) {
            ...
            if (empty($_POST['cif'])) {
                ...
                // datos de la tabla por cifm dni y código
                $distribuye = $gestion->query('select * from registra order by cif, dni, codigo desc');
                ...
                $resultado = $gestion->exec("insert into registra values("
                        . "$cif, "
                        . "$dni, "
                        . "$codigo, "
                        . "'$medio')");
        ...
        <div id="nuevo_registro">
            <form id="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <div>
                    <h3>Nuevo Registro de Registros</h3>
                    CIF: 
                    ...
                    Medio: <input type="text" id="medio" name="medio"/>
                </div>
                <div>
